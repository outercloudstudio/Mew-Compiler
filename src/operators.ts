import { CompilerType, INT, FLOAT, STRING, VOID, BOOL } from './types'
import {
	Block,
	Stack,
	SetVariableBlock,
...
export type Operator = {
	...
	operate(
		aValue: Block | string | Reference,
		aType: CompilerType,
		bValue: Block | string | Reference,
		bType: CompilerType,
		stack: Stack
		...
		stack.add(
			new SetVariableBlock(
				...
				new AddBlock(
					...
					new ItemOfListBlock('Operation Stack', new LengthOfListBlock('Operation Stack'))
				)
			)
		)
